...
angular.module('starter', [
  ...
  'docman.followers',
  'docman.confirmfollowers',
  'docman.firereg',
  'docman.fireuser-model',
  'docman.login',
  'docman.offline-model'
])
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    ...
    .state('app.invite', {
      ...
      views: {
        'menuContent': {
          templateUrl: 'templates/invite-manage.html',
          controller: 'FollowersCtrl'
        }
      }
    })

     .state('app.invite-terms', {
      url: '/invite-terms/:id',
      views: {
        'menuContent': {
          templateUrl: 'templates/invite-terms.html',
          controller: 'ConfirmFollowersCtrl'
        }
      }
    })
...
.controller('AppCtrl', function($state,$rootScope,$scope, $http,Auth, $window, $timeout, Docs, DocFile) {
...
rscope.$watch('online',function(newval,oldval)
  {
