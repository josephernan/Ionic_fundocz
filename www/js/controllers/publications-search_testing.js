...
.controller('PublicationsSearchCtrl', function ($scope, $stateParams, $timeout, $cordovaFileTransfer, $cordovaFileOpener2, $ionicPlatform, Funds, Docs, DocFile, Users, Auth) {
     ...
     Docs.getMonthDocs(year, month).then(function(docs){
        ...
        $scope.docs = docs;
			Funds.getInvitess(Auth.getEmail()).then(function(invited){
     		 console.log(invited);
     		 console.log('invited');
			 Funds.getInvitess().then(function(funds){
			 	$timeout(function(){
